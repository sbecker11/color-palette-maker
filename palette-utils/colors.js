/**
 * Palette color utilities - portable JS/TS, no framework deps.
 * Use in Node, browser, or Vite/React. Easy to port to TypeScript.
 */
...
/** Relative luminance (0-1). Used for contrast. Internal; not exported. */
...
/** RGB (0–255) to LAB. L in [0,100], a and b unbounded. Internal. */
function rgbToLab(r, g, b) {
  const { x, y, z } = rgbToXyz(r, g, b);
  return xyzToLab(x, y, z);
}

/** LAB to RGB (0–255). Internal. */
 ...
 * darker (L divided by multiplier). Light backgrounds use black icons; dark use
 * white (via CSS invert).
 * @param {string} hex - Base color hex
 * @param {{ highlightPercent?: number, nearlyWhiteL?: number }} [options] - highlightPercent default 135
 */
